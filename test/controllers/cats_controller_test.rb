...
class CatsControllerTest < ActionController::TestCase
  ...
  test "should create cat" do
    assert_difference('Cat.count') do
      post :create, cat: { description: @cat.description, name: @cat.name, owner_id: @cat.owner_id }
    end
  ...
  test "should update cat" do
    patch :update, id: @cat, cat: { description: @cat.description, name: @cat.name, owner_id: @cat.owner_id }
    assert_redirected_to cat_path(assigns(:cat))
  end
